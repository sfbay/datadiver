...
export const NON_SOCRATA: Record<NonSocrataId, NonSocrataSource> = {
  'sf-analysis-neighborhoods': {
    ...
    upstreamUrl: 'https://data.sf.gov/resource/j2bu-swwd.geojson?$limit=100',
    landingUrl: 'https://data.sf.gov/d/j2bu-swwd',
    ...
    socrataId: 'j2bu-swwd', socrataHost: 'data.sf.gov',
  },
  'sf-precincts-2012': {
    ...
    upstreamUrl: 'https://data.sf.gov/resource/bsfq-aeyw.geojson?$limit=1000',
    landingUrl: 'https://data.sf.gov/d/bsfq-aeyw',
    ...
    socrataId: 'bsfq-aeyw', socrataHost: 'data.sf.gov',
  },
  'sf-precincts-2022': {
    ...
    upstreamUrl: 'https://data.sf.gov/resource/d6x4-hefw.geojson?$limit=1000',
    landingUrl: 'https://data.sf.gov/d/d6x4-hefw',
    license: 'not stated', servedPath: '/data/elections/geo/prec-2022.geojson',
    generator: 'scripts/build-precinct-geometry.py', derivedLicense: 'CC BY 4.0',
    socrataId: 'd6x4-hefw', socrataHost: 'data.sf.gov',
  },
  ...
  'sf-tract-assignment': {
    ...
    upstreamUrl: 'https://data.sf.gov/resource/sevw-6tgi.json?$limit=1000',
    landingUrl: 'https://data.sf.gov/d/sevw-6tgi',
    license: PDDL, generator: 'scripts/patch-renter-households.py',
    socrataId: 'sevw-6tgi', socrataHost: 'data.sf.gov',
  },
  'acs-2023-5yr': {
