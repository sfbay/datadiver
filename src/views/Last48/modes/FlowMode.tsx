    ...
    <Last48Map
      rail={(map) => (
        <FlowRail
          ...
          onSelect={(ev) => {
            // Rail click never deselects — clicking an already-selected
            // row is a no-op (so an out-of-sequence pinned row doesn't
            // vanish when revisited). Deselection is reserved for Esc,
            // the X on the detail card, or an empty-area map click via
            // handleMapSelect (which DOES toggle).
