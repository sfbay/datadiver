...
export default function ParkingCitations() {
          ...
          <>
            <div className="flex items-center justify-end -mt-1 mb-1">
              <button
                ...
                className="text-nano font-mono text-terracotta-500/70 hover:text-terracotta-500 transition-colors"
              >
  ...
  useEffect(() => {
    ...
    const handleClick = (e: mapboxgl.MapLayerMouseEvent) => {
      ...
      // Offset so the citation lands clear of its own top-right detail card (w-72 = 288px).
