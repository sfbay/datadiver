...
import { useCitationHourlyPattern } from '@/hooks/useCitationHourlyPattern'
import { useCitationComparisonData } from '@/hooks/useCitationComparisonData'
      ...
      <div id="pc-capture" className="flex-1 overflow-hidden flex">
        ...
        <div className="flex-1 relative">
          <MapView ref={mapHandleRef} onMapReady={handleMapReady}>
            {isLoading && <MapLoadingIndicator label="Loading citations" color="#fb923c" />}
