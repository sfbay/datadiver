...
//   1. exact / near-exact `filer_name` in `4c8t-ngau`;
...
//   3. the consultant's own `acwz-2ua3` client statement, whose
//      `clientinformation_committeename` field names the committee ('Yes on B', 'ESER');
...
// as-filed name for the same `filer_nid` (committees rename mid-cycle), the evidence
// records both.
//
...
export const CLIENT_CROSSWALK: ClientEntry[] = [
  ...
  },
  {
    ...
    evidence:
      "Bare candidate name. 4c8t-ngau has both 'Danny Sauter for Supervisor 2024' (208713856, which pays KMM $159,082.74) and its officeholder committee; the filing does not say which, and KMM's $108,195.18 matches neither exactly. Not guessed.",
    reviewedAt: '2026-08-18',
  },
  {
  ...
  },
  {
    ...
    evidence:
      "Token match to 4c8t-ngau filer_name 'Term Limits Now - Yes on B!' (filer_nid 215271192); no filer exists under this name; 'Term Limits Now - Yes on B!' is the only term-limits committee in 4c8t-ngau and it pays BMWL Campaigns $467,837.50 — BMWL is the consultant reporting the $75,000. UNCERTAIN: name drift is large and the dollars are gross-vs-fee, not an equality.",
    reviewedAt: '2026-08-18',
  },
  {
  ...
  },
  {
    ...
    evidence:
      "Resolved against pitq-e56w Schedule E: 'Kim for School Board June 2026' (filer_nid 214769736) Nathan Allbee's only Kim payer in pitq-e56w is 'Kim for School Board June 2026' (filer_nid 214769736, $19,799.16 against $17,500 reported across his three Kim strings). 4c8t-ngau holds two near-identical Kim committees plus a '[delete]' row, so the money is the only safe discriminator. UNCERTAIN: the filer wrote 'July' where the committee says 'June'.",
    reviewedAt: '2026-08-18',
  },
  {
  ...
  },
  {
    ...
    filerName: "Kim for School Board June 2026",
    evidence:
      "Resolved against pitq-e56w Schedule E: 'Kim for School Board June 2026' (filer_nid 214769736) same resolution as the 'Schoolboard 2026 July' string — Allbee's only Kim payer is 214769736. UNCERTAIN for the same reason.",
    reviewedAt: '2026-08-18',
  },
  {
