...
const PEC = { short: 'Oakland PEC', full: 'City of Oakland Public Ethics Commission' }
...
export const OAKLAND_DATASETS_RAW: Record<string, RawDatasetConfig> = {
  ...
  cases311: {
    ...
    publisher: { short: 'OAK 311', full: 'City of Oakland Public Works and Department of Transportation (OAK 311)' },
    completeness: { edgeDays: 1 },
    category: 'other',
    hasGeo: false,
  ...
  parkingCitations: {
    ...
    publisher: { short: 'OakDOT', full: 'City of Oakland Department of Transportation' },
    completeness: { edgeDays: 1 },
