...
export const SF_ELECTIONS: ElectionCycle[] = [
  // A Nov cycle with a same-year spring election starts the DAY AFTER that
  // election (tiled, like Oakland's table) — otherwise the spring measures'
  // money counts in both pills (June's Yes on B showed up under Nov 2026).
  // A Nov cycle with no spring election that year keeps Jan 1.
  { label: 'Nov 2026',  date: '2026-11-03', start: '2026-06-03', end: '2026-11-03' },
  { label: 'June 2026', date: '2026-06-02', start: '2025-07-01', end: '2026-06-02' },
  { label: 'Nov 2024',  date: '2024-11-05', start: '2024-03-06', end: '2024-11-05' },
  { label: 'Mar 2024',  date: '2024-03-05', start: '2023-07-01', end: '2024-03-05' },
  { label: 'Nov 2022',  date: '2022-11-08', start: '2022-06-08', end: '2022-11-08' },
  { label: 'Jun 2022',  date: '2022-06-07', start: '2021-07-01', end: '2022-06-07' },
  { label: 'Nov 2020',  date: '2020-11-03', start: '2020-03-04', end: '2020-11-03' },
  ...
  { label: 'Nov 2018',  date: '2018-11-06', start: '2018-06-06', end: '2018-11-06' },
